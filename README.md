...
* **Prompt Architecture (PTCS Alignment):**
    ...
    ```
* **Live Example:** > *"Act as a friendly physics teacher. Explain the concept of inertia to me. Keep the explanation accessible to a complete beginner and use a clear, real-life analogy. Provide a short overview, followed by the analogy, and end with a quick summary bullet point."*
